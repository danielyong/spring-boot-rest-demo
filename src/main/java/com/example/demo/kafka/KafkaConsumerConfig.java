...
public class KafkaConsumerConfig {
  ...
  @Bean
  public ConsumerFactory<String, WeatherData> weatherDataConsumerFactory() {
  ...
  @Bean
  public ConcurrentKafkaListenerContainerFactory<String, WeatherData> weatherDataListenerContainerFactory() {
    ConcurrentKafkaListenerContainerFactory<String, WeatherData> factory = new ConcurrentKafkaListenerContainerFactory<>();
    factory.setConsumerFactory(weatherDataConsumerFactory());
    return factory;
  }
}
